    ...
    <footer>
      ...
      <div className="footer-info">
        <div className="footer-info-grid">
          ...
          {/* Quick Links Column */}
          <div className="footer-col">
            <h3 className="footer-col-title">Hurtiglinks</h3>
            <ul className="footer-col-list">
          ...
          {/* Credentials Column */}
          <div className="footer-col">
            <h3 className="footer-col-title">Christina Borreby</h3>
            <p className="footer-credentials">
              Cand.negot. &middot; Certificeret psykoterapeut &middot; 30+ års erfaring med heste
            </p>
          </div>
        </div>
